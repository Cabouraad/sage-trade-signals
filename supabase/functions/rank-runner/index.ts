...
serve(async (req) => {
  ...
  try {
    ...
    console.log('Starting ranking engine...');

    // Run the ranking algorithm directly in TypeScript
    const result = await runRankingEngine(supabaseClient);
...
async function runRankingEngine(supabase: any) {
